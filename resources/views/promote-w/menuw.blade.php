...
@section('search.target',route('promote-w.menuw'))
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col text-center my-4">
          <h1 class="fs-2s" style="color: #000; margin-top: 14%">MENU</h1>
                ...
                <a href="#">
                    <div class="product-item-1">
                        ...
                        <div class="product-content text-center py-3">
                            <span class="d-block text-uppercase fw-bold" style="color: #000">
                                Name :&nbsp;{{ $item->name }}
                            </span>
                            <span class="d-block" style="color: #000">Price :&nbsp; {{ number_format($item->price, 2) }} ฿</span>
                        </div>
                    </div>
                </a>
            </div>
