...
@section('content')
    ...
    <!-- Start Menu Area -->
    <section class="features-area section_gap" id="menuSection" style="background-color: #222222">
        <div class="container">
            <div class="col text-center my-4">
                <h1 class="fs-2s" style="color: #fff; margin-top:0px">MENU</h1>
    ...
    <!-- Promotion Area -->
    <section class="features-area section_gap" style="background-color: #222222">
        <div class="col text-center my-4">
