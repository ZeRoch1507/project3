    ...
    <div class="container1">
        <div class="row">
            ...
            <div class="col-xs-4 col-md-4">
                <h5 style="padding-top: 15%; margin-left: 25%; color: #101010">About</h5>
            ...
            <div class="col-xs-3 col-md-3">
                <h5 style="padding-top: 20%; margin-left: 30%; color: #101010">Contact</h5>
                <p style="padding-top: 10%; margin-left: 20%">
                    <!-- phone -->
                    <button class="genric-btn default circle" style="margin-top: 10px; background-color: #eeee; color: #101010; border-radius: 20px 20px;">
                        <img src="{{ asset('promote/img/icon/phone-logo.png') }}" width="17.5" height="17.5" style="margin-left: -10px" />
                        &nbsp; :&nbsp; 0616629664
                    </button>
                    <br />
                    ...
                    <!-- line -->
                    <button class="genric-btn default circle" style="margin-top: 10px; background-color: #eeee; color: #101010; border-radius: 20px 20px;">
                        <img src="{{ asset('promote/img/icon/line-logo.png') }}" width="17.5" height="17.5" style="margin-left: -10px" />
                        &nbsp; :&nbsp; @MEKAR
                    </button>
                    <br />
                    ...
                    <a href="https://www.facebook.com/MEKARCafeBistro" target="_blank">
                        <button class="genric-btn default circle" style="margin-top: 10px; background-color: #eeee; color: #101010; border-radius: 20px 20px;">
                            <img src="{{ asset('promote/img/icon/fb-logo.png') }}" width="17.5" height="17.5" style="margin-left: -10px" />
                            &nbsp; :&nbsp; MEKAR Cafe & Bistro
                        </button>
                    </a>
                    <br />
                    ...
                    <a href="https://www.instagram.com/mekarcafebistro" target="_blank">
                        <button class="genric-btn default circle" style="margin-top: 10px; background-color: #eeee; color: #101010; border-radius: 20px 20px;">
                            <img src="{{ asset('promote/img/icon/ig-logo.png') }}" width="17.5" height="17.5" style="margin-left: -10px" />
                            &nbsp; :&nbsp; MEKAR Cafe & Bistro
                        </button>
                    </a>
                    <br />
